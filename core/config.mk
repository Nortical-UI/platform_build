...
include vendor/nortical/config/BoardConfigNortical.mk
...
ifneq ($(wildcard device/nortical/sepolicy/common/sepolicy.mk),)
$(eval include device/nortical/sepolicy/common/sepolicy.mk)
endif
...
# Include Nortical configs.
include vendor/nortical/build/core/config.mk
